  ...
  return (
    ...
    <div className="flex flex-col items-center justify-between w-[280px] h-[380px] border border-gray-300 rounded-lg overflow-hidden shadow-md bg-white p-2">
      ...
      <div className="flex flex-col items-center p-2 w-full flex-grow">
        <h3 className="text-lg font-bold mt-2 mb-1 text-center line-clamp-2">
          {product.name}
        </h3>
        <p className="text-xs text-center mb-2 text-gray-600 line-clamp-3">
          {product.description}
        </p>
        ...
        <Button className="bg-black hover:bg-gray-800 text-white px-4 py-1 rounded-lg text-sm mt-auto">
          Add to Cart
        </Button>
      </div>
    </div>
